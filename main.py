...
if __name__ == '__main__':
    ...
    server.http_run(config, reload_time, auto_update, save_log, interval, auto_update_interval, site_dic, login_dic, folder_path, data_path, cookie_path, log_path, queue_path, pdf_path, port, domain, use_proxy, proxy_port, proxy_ssl)